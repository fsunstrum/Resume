...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: R, C/C++, Java, HTML/CSS} \\
     \textbf{Frameworks/Tools}{: Git, ggplot2, Tidyverse, RStudio, VS Code} \\
    }}
 \end{itemize}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{4-coumaroyl-coa ligases in the biosynthesis of the anti-diabetic metabolite montbretin A. (2021) - \break {\textbf {First Author {\href{https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0257478}{\underline{(link)}}}}}}
    \item{A genetic linkage map in southern-by-spring oat identifies multiple quantitative trait loci for adaptation and rust
